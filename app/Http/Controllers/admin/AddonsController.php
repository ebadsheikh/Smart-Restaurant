...

{
...

    {
        ...
        $getaddons = Addons::select('addons.*')->with('category')->with('item')->join('categories','addons.cat_id','=','categories.id')->join('item', 'addons.item_id','=', 'item.id')->where('categories.is_available','1')->where('item.item_status', '1')->where('addons.is_deleted','2')->get();

        return view('addons',compact('getcategory','getitem','getaddons'));
