    ...
    ********************-->
    ...
    <div id="main-wrapper">
              ...
              <div class="modal-header">
                ...
                <div class="modal-body">
                  <h5><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Hello, Users</h5>
                    ...
                    <hr>
                  <h5><i class="fa fa-envelope" aria-hidden="true"></i> Contact at : <a href="mailto:sheikh.ebad6@gmail.com">sheikh.ebad6@gmail.com</a></h5>
                </div>
            </div>
          </div>
        </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="#" target="_blank">Sheikh Ebad</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
