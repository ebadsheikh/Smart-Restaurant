...
<footer>
	...
	<div class="container d-flex justify-content-between flex-wrap">
		...
		<div class="footer-head">
			...
			<div class="footer-logo" style="max-width:230px !important;"><img style="max-width:220px;" src='{!! asset("images/about/".$getabout->footer_logo) !!}' alt=""></div>
			...
			<div class="download-app-wrap">
				...
				@if($getabout->ios != "")
					...
					<div class="download-app-icon">
						...
						<a href="{{$getabout->ios}}" target="_blank"><img src="{!! asset('front/images/apple-store.svg') !!}" alt=""></a>
				...
				@if($getabout->android != "")
					...
					<div class="download-app-icon">
						...
						<a href="{{$getabout->android}}" target="_blank"><img src="{!! asset('front/images/play-store.png') !!}" alt=""></a>
	...
	<div class="copy-right text-center">
		...
		<p>{{$getabout->copyright}} <br> Designed & Developed by <a href="#" target="_blank" style="color: rgb(184, 182, 182);"><b>Sheikh Ebad</b>.</a></p>
